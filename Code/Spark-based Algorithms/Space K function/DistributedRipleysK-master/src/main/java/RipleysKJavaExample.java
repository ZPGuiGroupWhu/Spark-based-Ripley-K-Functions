...
import org.wysrc.distributedRipleysK.analysis.EdgeCorrectionType;
import org.wysrc.distributedRipleysK.analysis.PointPatternAnalysis;
import org.wysrc.distributedRipleysK.analysis.RipleysKResult;
import org.wysrc.distributedRipleysK.analysis.SimulationType;
...
import org.wysrc.distributedRipleysK.serde.RipleysKFunctionKryoRegistrator;
...
//        String tripPath = resourcePath+"yellow_tripdata_2009-01-subset.csv";
        ...
        boolean cout = Boolean.valueOf(args[19]);
        boolean all = Boolean.valueOf(args[20]);
        String outputPath = args[21];
        ...
        executeRipleysK(master, pointCSVPath, useFormatter, polygonPath, useEnvelopeBoundary, pointSize, maxSpatialDistance, maxTemporalDistance, temporalUnit,
                ...
                useIndex, useCache, useKryo, cout, all, outputPath);
...
//        System.out.println("Finished RipleysK Example.");
    ...
    public static void executeRipleysK(String master, String pointCSVPath, boolean useFormatter, String polygonPath, boolean useEnvelopeBoundary,
                                       ...
                                       boolean useIndex, boolean useCache, boolean useKryo, boolean cout, boolean all, String outputPath) throws Exception {
...
//        long maxTemporalDistance = (spatiotemporalPointRDD.envelope.getTemporalInterval(ChronoUnit.YEARS) + 3) / 4;
        ...
        RipleysKResult result = PointPatternAnalysis.SpatiotemporalRipleysKFunction(sparkSession, spatiotemporalPointRDD,
                ...
                estimationCount, simulationTypeEnum, simulationCount, usePartition, useIndex, useCache, cout, all);
...
//            String time = row.getAs("time");
            String time = "07/01/1996 00:00:00";
            if(useFormatter) {
        ...
        //以下代码验证发现：从hdfs中读取的数据居然和本地读取的文件不同，本地的话取前10000，hdfs的话随机
//        List<Row> collect = pointDS.toJavaRDD().collect();
//        List<Row> tmp = new ArrayList<>();
//        for (Row r : collect) {
//            tmp.add(r);
//        }
//        Collections.sort(tmp, new Comparator<Row>() {
//            @Override
//            public int compare(Row o1, Row o2) {
//                double x1 = o1.getAs("latitude");
//                double y1 = o1.getAs("longitude");
//
//                double x2 = o2.getAs("latitude");
//                double y2 = o2.getAs("longitude");
//
//                if (x1 == x2) {
//                    return (y1 < y2) ? 1 : -1;
//                }
...
//        });
//        for (Row r : tmp) {
//            double x = r.getAs("latitude");
//            double y = r.getAs("longitude");
