...
public abstract class SpatiotemporalGeometry implements Cloneable, Comparable, Serializable {
    ...
    /**
     * Count of occurrences of this spatiotemporal geometry (for aggregate replications)
     */
    int count;
    ...
    /**
     * Get count of this spatiotemporal geometry
     * @return the count
     */
    public int getCount() {
        return count;
    ...
    /**
     * Records the count of this spatiotemporal geometry
     *
