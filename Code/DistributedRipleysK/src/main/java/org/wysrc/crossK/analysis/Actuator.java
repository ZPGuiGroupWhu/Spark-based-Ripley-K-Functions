...
import org.wysrc.crossK.geom.SpatiotemporalPolygon;
import org.wysrc.crossK.index.IndexType;
import org.wysrc.crossK.partitioner.PartitionerType;
import org.wysrc.crossK.serde.RipleysKFunctionKryoRegistrator;
import org.wysrc.crossK.spatiotemporalRDD.SpatiotemporalPointRDD;
...
public class Actuator {
    ...
    public static void executeCrossRipleysK(String master, String polygonPath, boolean useEnvelopeBoundary,
                                       ...
                                       boolean useIndex, boolean useCache, boolean useKryo, String outputPath, String type1, int pointSize1, String type2, int pointSize2) throws Exception {
        ...
        JavaRDD<SpatiotemporalPoint> pointJavaRDD = readPointByDataset(sparkSession, type1, pointSize1, 0);
        JavaRDD<SpatiotemporalPoint> pointJavaRDD2 = readPointByDataset(sparkSession, type2, pointSize2, 1);
        pointJavaRDD = pointJavaRDD.union(pointJavaRDD2);

        System.out.println(pointJavaRDD.count());
    ...
    public static JavaRDD<SpatiotemporalPoint> readPointByDataset(SparkSession sparkSession, String pointCSVPath, int size, int type) {
...
//            String type = (int)(Math.Random()*99)
            SpatiotemporalPoint point = new SpatiotemporalPoint(new Coordinate(x, y), dateTime, type);
            return point; // todo, read type from file....
        });
